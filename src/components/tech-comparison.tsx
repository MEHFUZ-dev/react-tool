        ...
        {filteredTechnologies.length > 6 && (
          <div className="text-center mb-12">
            <button
              ...
              className="group relative bg-white border-2 border-purple-600 hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-600 text-black hover:text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto overflow-hidden"
            >
              {showAll ? (
                <>
